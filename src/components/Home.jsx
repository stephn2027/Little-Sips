...
export default function Home() {
  ...
  useLayoutEffect(() => {
    timeline
      .from('.homes', { opacity: 0, y: 65, delay: 0.2, ease: 'power4.out' })
      .from('.brand-sub', {
        opacity: 0,
        x: 65,
        delay: 0.2,
    ...
    <React.Fragment>
      <div className="home-container">
        ...
        <Content
          ...
          text={
            "Little Sips Cafe is a place where coffee & sweets aren't just a treat, but an experience. From lattes to our signature waffles, we have it all - watch as we prepare our delicious creations right before your eyes!"
          }
        />
        <ProductsSlider />
        <FillerContent
